    ...
    render() {
        return (
            <div className="circuit-builder" >
                <ReactNotification />
                <Board context={this.state.context} chips={this.state.chips} wires={this.state.wires} onChipDelete={this.removeChipFromBoard.bind(this)} onPinClicked={this.addWireToBoard.bind(this)} onWireDelete={this.removeWireFromBoard.bind(this)} redraw={() => this.forceUpdate.bind(this)}></Board>
